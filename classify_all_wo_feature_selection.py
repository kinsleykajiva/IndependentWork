...
final_featuresets = stem_featuresets
final_featuresets += hum_featuresets
final_featuresets += soc_featuresets
...
# TRIAL 1
train_set, test_set = final_featuresets[one_quarter:], final_featuresets[one_quarter:len_of_featuresets]
...
# TRIAL 2
train_set, test_set = final_featuresets[one_quarter:len_of_featuresets], final_featuresets[0:one_quarter]
...
# TRIAL 3
train_set, test_set = final_featuresets[0:(2*one_quarter)]+final_featuresets[-one_quarter:], final_featuresets[(2*one_quarter):(3*one_quarter)]
...
# TRIAL 4
train_set, test_set = final_featuresets[one_quarter:]+final_featuresets[(one_quarter*2):len_of_featuresets], final_featuresets[one_quarter:(one_quarter*2)]
