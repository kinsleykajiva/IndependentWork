...
# TRIAL 2
train_set = featuresets[one_quarter:]+featuresets[(2*one_quarter):len_of_featuresets]
test_set = featuresets[(one_quarter):(2*one_quarter)]
...
# TRIAL 3
train_set = featuresets[0:(one_quarter*2)]+featuresets[-one_quarter:]
test_set = featuresets[(2*one_quarter):(3*one_quarter)]
...
# TRIAL 4
train_set = featuresets[-(one_quarter*3):]
test_set = featuresets[0:one_quarter]
