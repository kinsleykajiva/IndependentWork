...
dev_test_set = [({"contains(several,test)":True},"Not Satisfied"),({"contains(many,assignment)":True},"Not Satisfied"),({"contains(most,office hours)":True},"Not Satisfied"),({"contains(less,exam)":True},"Satisfied"),({"contains(least,reading)":True},"Satisfied"),({"contains(few,reading)":True},"Satisfied"),({"contains(little, reading)":True},"Satisfied")]
