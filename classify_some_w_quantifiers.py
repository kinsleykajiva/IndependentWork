...
with open('batch_results_stem.csv','rU') as csvfile:
    ...
    for row1,row2,row3 in grouper(reader, 3):
        ...
        featuresets.append((features,sentiment,"STEM"))
...
with open('batch_results_hum.csv','rU') as csvfile:
    ...
    for row1,row2,row3 in grouper(reader, 3):
        ...
        featuresets.append((features,sentiment,"HUM"))
...
with open('batch_results_soc.csv','rU') as csvfile:
    ...
    for row1,row2,row3 in grouper(reader, 3):
        ...
        featuresets.append((features,sentiment,"SOC"))
...
# TRIAL 1
train_set = [(features,sentiment) for features,sentiment,dom in featuresets[(one_quarter*3):]]
test_set = [(features,sentiment) for features,sentiment,dom in featuresets[(3*one_quarter):len_of_featuresets] if dom == goal_dom]
...
# TRIAL 2
train_set = [(features,sentiment) for features,sentiment,dom in featuresets[one_quarter:]+featuresets[(2*one_quarter):len_of_featuresets]]
test_set = [(features,sentiment) for features,sentiment,dom in featuresets[(one_quarter):(2*one_quarter)] if dom == goal_dom]
...
# TRIAL 3
train_set = [(features,sentiment) for features,sentiment,dom in featuresets[0:(one_quarter*2)]+featuresets[-one_quarter:]]
test_set = [(features,sentiment) for features,sentiment,dom in featuresets[(2*one_quarter):(3*one_quarter)] if dom == goal_dom]
...
# TRIAL 4
train_set = [(features,sentiment) for features,sentiment,dom in featuresets[-(one_quarter*3):]]
test_set = [(features,sentiment) for features,sentiment,dom in featuresets[0:one_quarter] if dom == goal_dom]
